...
```
One example of value systems in databases/systems is assumptions and inequalities in standardized educational testing. Systems like the high stakes tests, e.g., SAT, TOEFL or provincial exams, e.g., EQAO, are built on a meritocracy system, offering an objective, standardized benchmark to measure all students performances. However these databases and the tests are built based on a stratification of population and only measure hypotherized constructs of skills, e.g., readng skills, language skills, academic performance. They value high-pressure, rapid-recall test-taking skills but neglecting soft-skills such as attention, creativity, self-regulations, or long-term critical thinking and collaborative problem-solving. 
The standardization procedures also systematically neglect marginalized groups. The testing data are highly correlated with family income. Students from wealthier backgrounds have access to expensive test prep courses, private tutors, and better-resourced schools. The test, therefore, does not just measure skills; instead, it measures access to resources. Furthermore, cultural biases in items can disadvantage English language learners or students from other cultural backgrounds, leading to differential item functioning across groups. College admissions databases then use these scores as a primary filter, introducing socioeconomic bias into what claims to be a fair, data-driven decision. This reinforces educational inequality, limiting social mobility for those who do not fit the narrow, privileged mold the system was built to value.
```
